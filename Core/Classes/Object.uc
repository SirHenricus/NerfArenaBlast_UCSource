...
/////////////////////////
//
// NERF: Tracing API (DWG)
//
//	C++ DEFINITION: void SetTrace(const TCHAR* Topic, const INT Depth, const INT Dynamic);
native(737) final static function SetTrace(coerce string Topic, coerce int Depth, coerce int Dynamic);

//	C++ DEFINITION: void GetTrace(TCHAR* Topic, INT Depth, INT Dynamic);
native(738) final static function GetTrace(out coerce string Topic, out coerce int Depth, out coerce int Dynamic);

//
// NERF: Config API (DWG)
//
//	C++ DEFINITION: void SetConfigString(const TCHAR* Section, const TCHAR* Key, const TCHAR* Value, const TCHAR* Filename=NULL);
native(739) final static function SetConfigString(coerce string Section, coerce string Key, coerce string Value, coerce string Filename);

//	C++ DEFINITION: void GetConfigString(const TCHAR* Section, const TCHAR* Key, const TCHAR* Filename=NULL);
native(740) final static function string GetConfigString(coerce string Section, coerce string Key, coerce string Filename);
//
/////////////////////////
