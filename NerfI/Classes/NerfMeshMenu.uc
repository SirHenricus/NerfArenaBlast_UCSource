...
// Integrated by Wezo
//=============================================================================
class NerfMeshMenu extends NerfPlayerMenu
	config;

var Class<PlayerPawn> PlayerClass;
var string PlayerClasses[33];
...
function PostBeginPlay()
{
	...
	Super.PostBeginPlay();
	NextPlayer = GetNextInt("NerfiPlayer", 0); 
	while ( (NextPlayer != "") && (NumPlayerClasses < 33) )
	{
		PlayerClasses[NumPlayerClasses] = NextPlayer;
		NumPlayerClasses++;
		NextPlayer = GetNextInt("NerfiPlayer", NumPlayerClasses);
	}
}	
