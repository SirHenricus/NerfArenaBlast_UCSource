...
// NerfVideoMenu
//=============================================================================
class NerfVideoMenu extends NerfLongMenu;
...
defaultproperties
{
     ...
     HelpMessage(2)=Display Nerf in a window. Note that going to a software display mode may remove high detail actors that were visible with hardware acceleration.
