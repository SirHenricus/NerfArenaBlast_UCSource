//=============================================================================
// TutorialEvent: Receives trigger messages and does some "special event"
// depending on the state.
// New Sounds interrupt previous sounds
//=============================================================================
class TutorialEvent extends Triggers;

#exec Texture Import File=g:\NerfRes\NerfMesh\Textures\TutSpcl.pcx Name=S_TutEvent Mips=Off Flags=2
...
state() PlaySoundEffect
{
	...
	{
		Global.Trigger( Self, EventInstigator );
        Level.Game.GamePlaySound( Sound );
	}
}
...
defaultproperties
{
     Texture=Texture'NerfI.S_TutEvent'
}
