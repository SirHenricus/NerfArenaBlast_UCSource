...
// Integrated by Wezo
//=============================================================================
class NerfOptionsMenu extends NerfLongMenu;
...
function bool ProcessSelection()
{
	...
	else if ( Selection == 11 )
	{
		...
		ChildMenu = spawn(class'NerfKeyboardMenu', owner);
	else if ( Selection == 13 )
		ChildMenu = spawn(class'NerfWeaponMenu', owner);
...
function DrawMenu(canvas Canvas)
{
	...
	if (Selection==14)	
	{
		switch(PlayerOwner.MyHud.HudMode)
		{
			case 0:	HUDIcon[0]=Texture(DynamicLoadObject("NerfRes.Hud1", class'Texture'));
					break;
			case 1:	HUDIcon[1]=Texture(DynamicLoadObject("NerfRes.Hud2", class'Texture'));
					break;
			case 2:	HUDIcon[2]=Texture(DynamicLoadObject("NerfRes.Hud3", class'Texture'));
					break;
			case 3:	HUDIcon[3]=Texture(DynamicLoadObject("NerfRes.Hud4", class'Texture'));
					break;
			case 4:	HUDIcon[4]=Texture(DynamicLoadObject("NerfRes.Hud5", class'Texture'));
					break;
			case 5:	HUDIcon[5]=Texture(DynamicLoadObject("NerfRes.Hud6", class'Texture'));
					break;
		}
