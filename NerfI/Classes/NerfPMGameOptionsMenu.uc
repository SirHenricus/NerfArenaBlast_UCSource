//=============================================================================
// NerfPMGameOptionsMenu
//
// Integrated by Wezo
//=============================================================================
class NerfPMGameOptionsMenu extends NerfGameOptionsMenu;
...
function bool ProcessSelection()
{
	...
	{
		ChildMenu = spawn(class'NerfBotConfigMenu', owner);
		ChildMenu.ParentMenu = self;
		NerfBotConfigMenu(ChildMenu).InitConfig(GameType);
	}
	else if ( Selection == 8 )
...
defaultproperties
{
     ...
     GameStyle(2)=Turbo
     GameClass=Class'NerfI.DeathMatchGame'
     MenuLength=9
     HelpMessage(3)=Number of points scored by leading player to end game.  If 0, there is no limit.
