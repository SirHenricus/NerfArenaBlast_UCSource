class NerfPlayerMeshClient extends UWindowDialogClientWindow;

var NerfButtonControl FaceButton;
...
function Created()
{
	...
	FaceButton = NerfButtonControl(CreateControl(class'NerfButtonControl', 0, WinHeight - 16, 48, 16));
...
function AnimEnd(NerfMeshActor MyMesh)
{
