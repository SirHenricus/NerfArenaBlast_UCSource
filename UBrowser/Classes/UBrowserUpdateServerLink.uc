...
{
	MaxURI = 3;
	URIs[3] = "/atari/nerfnews"$Level.EngineVersion$".htm";
	URIs[2] = "/atari/nerfnews.htm";
	URIs[1] = "/atari/nerfmaster.txt";
	URIs[0] = "";
}
...
defaultproperties
{
     UpdateServerAddress=www.hasbro-interactive.com
     UpdateServerPort=80
     UpdateServerTimeout=20
}
