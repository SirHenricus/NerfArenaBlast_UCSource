...
{
	if ((PlayerPawn(Owner) != None) && (PlayerPawn(Owner).DesiredFOV > 90))
		bHideWeapon = true;
...
{
	//Play Loading animation and sound
}
...
defaultproperties
{
     ...
     DeathMessage=%o was knocked out by %k's %w.
