...
// NERF:DSL: changed this to twelve to account for SHBall pseudo-ammo, ( SHBall defprop sets Ammo[11] to 1 )
// and to appease compile time warnings
//var() byte UsedInWeaponSlot[10];
var() byte UsedInWeaponSlot[12];	
var   ammo  PAmmo;
